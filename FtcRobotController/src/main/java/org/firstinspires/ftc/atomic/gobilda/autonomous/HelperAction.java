...
public abstract class HelperAction extends LinearOpMode {
    ...
    protected ColorSensor top_sensor;
    protected ColorSensor bottom_sensor;
...
//        }
    ...
    public boolean identify_Rings(ColorSensor top_color_sensor,
                                  ColorSensor bottom_color_sensor,
                                  float hsvValues[]) {

        boolean top_sensor_result = isThisOrangeRing(top_color_sensor, hsvValues);
        boolean bottom_sensor_result = isThisOrangeRing(bottom_color_sensor, hsvValues);

        return true;
    }

    public boolean isThisOrangeRing(ColorSensor colorSensor, float hsvValues[]){
